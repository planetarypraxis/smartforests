...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('smartforests', '0013_change_tag_constraints_for_localization'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='mappage',
            name='og_image',
            field=models.ForeignKey(blank=True, help_text='Shown when linking to this page on social media.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='smartforests.cmsimage', verbose_name='Preview image'),
        ),
        migrations.AddField(
            model_name='mappage',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='A photo of the facility. This photo will be cropped to 1:1, 4:3, and 16:9 aspect ratios automatically.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='smartforests.cmsimage', verbose_name='Photo of Organization'),
        ),
        migrations.AddField(
            model_name='mappage',
            name='struct_org_logo',
            field=models.ForeignKey(blank=True, help_text='Leave blank to use the logo in Settings > Layout > Logo', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='smartforests.cmsimage', verbose_name='Organization logo'),
        ),
        migrations.AddField(
            model_name='mappage',
